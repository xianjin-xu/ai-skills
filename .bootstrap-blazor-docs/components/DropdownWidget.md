...
**分类**: 反馈
**在线演示**: [https://www.blazor.zone/dropdown-widget](https://www.blazor.zone/dropdown-widget)

## 参数 (Parameters)

| 参数名 | 类型 | 默认值 | 说明 |
|--------|------|--------|------|
| `ChildContent` | `RenderFragment?` | `}` | 获得/设置 选项模板支持静态数据 |
| `Items` | `IEnumerable<DropdownWidgetItem>?` | `}` | 获得/设置 挂件数据集合 |
| `Task` | `Func<DropdownWidgetItem,` | `}` | 获得/设置 下拉项关闭回调方法 |
